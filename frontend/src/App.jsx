...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      {/* Header */}
      <header className="bg-blue-600 text-white py-4 text-center font-semibold text-lg shadow-md">
        💬 Chatbot Assistant
      </header>

      {/* Chat area */}
      <main className="flex-1 flex justify-center overflow-hidden">
        <div className="flex flex-col w-full max-w-3xl bg-white shadow-lg m-4 rounded-2xl overflow-hidden">
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
            ...
            {isTyping && (
              <div className="flex justify-start">
                <div className="bg-gray-200 px-4 py-3 rounded-2xl rounded-bl-none text-sm text-gray-600 shadow">
